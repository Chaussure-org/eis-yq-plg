...
@RestController
@Api(tags = "wcsCommandHistoryView管理")
@RequestMapping("/api/v1/master/wcscommandhistoryview")
public class PrologWcsCommandHistoryViewController {
    @Autowired
    ...
    {
        return "id,taskId,type,address,target,containerNo,priority,weight,stationNo,lights,sourceLayer,targetLayer,result,gmtSendTime,gmtCreateTime,status";
    }

    private String getTableName()
    {
        return "wcscommandhistoryview";
    }
