...
@RestController
@RequestMapping("/api/v1/master/billfailing")
public class PrologBillFailingController {
    ...
    private String getColumns() {
        return "billNo,waveNo,dealerId,goodsNo,goodsName,planNum,createTime";
    }

    private String getTableName() {
        return "billfailingview";
    }
