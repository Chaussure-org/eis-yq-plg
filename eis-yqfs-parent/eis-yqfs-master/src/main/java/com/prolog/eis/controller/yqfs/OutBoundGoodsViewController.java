 ...
 * @author LuoLi
 * @version 1.0
 * @date 2020/8/11 12:37
 */

@RestController
@RequestMapping("/api/v1/master/outboundgoods")
public class OutBoundGoodsViewController {
    ...
    private String getColumns() {
        return "billNo,waveNo,goodsName,goodsNo,planNum,place,dealerName,createTime";
    }

    private String getTableName() {
        return "outboundgoodsview";
    }
}
