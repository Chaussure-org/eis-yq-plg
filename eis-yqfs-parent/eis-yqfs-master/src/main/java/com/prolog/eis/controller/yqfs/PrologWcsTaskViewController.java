...
@RestController
@Api(tags = "wcsTaskView管理")
@RequestMapping("/api/v1/master/wcstaskview")
public class PrologWcsTaskViewController {
    @Autowired
    ...
    {
        return "id,adddress,target,eisType,wcsType,orderBoxNo,containerNo,status,gmtCreateTime";
    }
