...
@RestController
@Api(tags = "合箱料箱库存查询")
@RequestMapping("/api/v1/master/lxInfo")
public class PrologLxInfoController {
	...
	private String getColumns() {
		return "id,containerNo,containerSubNo,expiryDate,goodsId,goodsNo,goodsName,goodsBarCode,layer,x,y,storeTime,commodityNum,referenceNum";
	}
