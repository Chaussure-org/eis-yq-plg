...
@RestController
@Api(tags = "pdtaskdetailhis管理")
@RequestMapping("/api/v1/master/pdtaskdetailhis")
public class PrologpdtaskdetailhisController {
    ...
    {
        return "pdTaskId,containerNo,containerSubNo,goodsNo,goodsName,barCode,originalCount,modifyCount,createTime,pdType";
    }

    private String getTableName()
    {
        return "pdtaskdetailhisview";
    }
}
