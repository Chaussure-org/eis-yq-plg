...
@RestController
@Api(tags = "billnoview管理")
@RequestMapping("/api/v1/master/billnoview")
public class PrologbillnoviewController {
    ...
    {
        return "waveNo,place,billNo,dealerName,orderBoxNo,expectTime,status,userName,dealerId";
    }
