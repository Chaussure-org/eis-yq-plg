...
public class OutBoundTaskHzDto implements Serializable {
    @Column("id")
    @Id
    @ApiModelProperty("id")
    ...
    private Date dealTime;//建单时间

    @ApiModelProperty("出库单明细")
    private List<OrderMx> orderMxs;

    public OutBoundTaskHzDto() {
    }

    public OutBoundTaskHzDto(Integer id, Integer pickingOrderId, String outboundCode, Date pickDateTime, Date createTime, Date lastDateTime, Date expectTime, Integer priority, String orderBoxNo, Integer stationId, Integer isAddPool, String billNo, String loanNo, Date loanDateTime, int dealerId, String goodsFactory, String transferLibrary, String deliverGoodsMode, String shippingPoint, String storeNo, String deliverGoodsType, String dealerAddress, double weight, double netWeight, double money, Date confirmTime, String crtatStaff, Date dealTime, List<OrderMx> orderMxs) {
        this.id = id;
